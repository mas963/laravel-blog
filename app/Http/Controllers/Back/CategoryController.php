...
class CategoryController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $category->save();
        toastr()->success($request->category.' Kategorisi başarıyla oluşturuldu');
        return redirect()->back();
    ...
    public function update(Request $request){
        ...
        $category->save();
        toastr()->success($request->category.' Kategorisi başarıyla güncellendi');
        return redirect()->back();
    ...
    public function delete(Request $request){
        ...
        $category->delete();
        toastr()->success($message,"Kategorisi başarıyla silindi");
        return redirect()->back();
    }
